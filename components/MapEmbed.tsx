...
const MapEmbed: React.FC = () => {
    return (
        <motion.div
            id="reachus"
            className="w-full px-4 py-12 md:px-16 bg-white"
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.7, ease: "easeOut" }}
            viewport={{ once: true }}
        >
            <Card className="shadow-2xl rounded-2xl overflow-hidden border-0 mx-28">
                <CardContent className="p-0 flex flex-col md:flex-row">
                    ...
                    {/* Map Section */}
                    <div className="w-full md:w-1/2 h-[600px] md:h-[400px]">
                        <iframe
