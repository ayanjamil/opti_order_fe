...
const FAQ: React.FC = () => {
    return (
        <section id="faq" className="py-10 lg:py-20 mx-auto max-w-6xl px-4 md:px-8">
            <div className="flex flex-col lg:flex-row gap-10">
                <div className="">
                    ...
                    {/* <a href="mailto:" className="mt-3 block text-xl lg:text-4xl text-secondary font-semibold hover:underline text-center lg:text-left">nishit@fnxlabs.co</a> */}
                </div>
